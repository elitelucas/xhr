...
<head>
    ...
    <title><?php echo  C("app_webname");?> - 用户登录</title>
    ...
    <style type="text/css">
        body {
            background-image: url("statics/new_admin/images/bg-login.jpg");
...
<div class="login-wrapper layui-anim layui-anim-scale layui-hide">
    <form class="layui-form" action="?m=admin&c=login&a=login&dosubmit=1" method="post">
        <h2>用户登录</h2>
        ...
        <?php  if($random_code_is_open == '0') { ?>
            <div class="layui-form-item layui-input-icon-group login-captcha-group">
                <i class="layui-icon layui-icon-auz"></i>
                <input class="layui-input" name="code" placeholder="请输入验证码" autocomplete="off"
                       lay-verType="tips" lay-verify="required" required/>
                <input type="hidden" name="code_type" value="pic_code" />
                <img class="login-captcha" alt=""/>
            </div>
        <?php  } else { ?>
            <div class="layui-form-item layui-input-icon-group">
                <i class="layui-icon layui-icon-auz"></i>
                <input class="layui-input" name="code" placeholder="请输入授权验证码" autocomplete="off"
                       lay-verType="tips" lay-verify="required" required/>
                <input type="hidden" name="code_type" value="random_code" />
            </div>
        <?php  } ?>
...
<div class="login-copyright">copyright © 2020 <?php echo  C("app_webname");?> all rights reserved.</div>
...
<!-- js部分 --><script type="text/javascript" src="statics/new_admin/libs/layui/layui.js"></script><script type="text/javascript" src="statics/new_admin/js/common.js?v=318"></script><script type="text/javascript">
    layui.use(['layer', 'form'], function () {
        ...
        /* 图形验证码 */
        var captchaUrl = '?m=admin&c=login&a=verificationCode';
