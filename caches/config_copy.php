...
return [
    ...
    /** 项目设置 */
    'app_home'            => 'http://www.kirin88.com', //** 不带 '/'
//'app_home' => 'http://www.pc520.com', //** 不带 '/'
    'app_dir'             => '/', //程序安装目录，不带'/'
    'cdn_path'            => '/statics/', //cdn访问地址
    'auth_key'            => 'MZFcm4Iagyy9ypeFPleg', //密钥
    'app_webname'         => '乐购28', //项目名称


    /** 数据库设置 */
    'db_host'             => 'localhost', //Server
    'db_name'             => 'chat', //数据库名称
//'db_name' => 'chatest', //数据库名称
    'db_user'             => 'root', //用户名
    'db_pwd'              => '71YjopVCjiO2@#1', //密码 123456
    'db_prefix'           => 'un_', //数据前缀
    'db_lang'             => 'utf8', //数据库编码
...
//联合会员中间站API：设置PC手游用户在线状态
    'transfer_site_set_status' => 'http://120.76.218.90/mu/union/handle/set_pcsy_online_status',
];
