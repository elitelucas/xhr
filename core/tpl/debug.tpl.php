...
<div class="notice">
    ...
    <div><?php echo L('select');?> [ <a href="<?php echo __URL__;?>"><?php echo L('tautology');?></a> ] [ <a href="javascript:history.back()"><?php echo L('back');?></a> ] <?php echo L('or');?> [ <a href="<?php echo C('app_home');?>" target="_top"><?php echo L('gohome');?></a> ]</div>
    <?php if(isset($e['file'])):?>
...
<div id="footer"> <?php echo L('sys.name');?> <sup><?php echo L('sys.var');?></sup></div>
