...
class FeiFuBa extends PayInfo
{
    //请求接口Url

    public $url = 'https://gaoshoucoming.com/Pay_Index.html';               //扫码正式（线上）调用接口
    public $h5_url = 'https://gaoshoucoming.com/Pay_Index.html';
    public $payName = '菲付吧支付';   //接口名称
    ...
    public function doPay($data)
    {
        ...
        payLog('klt.txt',print_r($post_data,true). "---92");
...
//            payLog('klt.txt',$url. "   ====137");
    ...
    public function doPaycallBack($postData)
    {
        ...
        $retSign = $this->retSigned($data, $config['merchantPublicKey']);
